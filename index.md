...
2. Click Sort.
  - Sort is found in the data tool bar. <br>
   <img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step1.5.PNG" width = "450" height = "325" >
...
<img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%202.1.PNG" width = "450" height = "325" >
...
5. Choose how you want to sort. <br>
 ...
 <img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%202.PNG" width = "450" height = "325" 
6. Once you choose how to sort, hit ok and the data will sort! <br> <br>
  A-Z by country<br>
 <img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%202.2.PNG" width = "200" height = "325" >
  Z-A by country <br> <img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%202.3.PNG" width = "200" height = "325" > <br> 
 A-Z by Sno Cone <br> <img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%202.4.PNG" width = "200" height = "325" >
...
2. In the right box (titled List Entries), you can enter the items that the list should be sorted by. <br>
 ...
 <img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%203.1.PNG" width = "450" height = "325" >

3. This will cause the data to sort by counties, with more important counties at the top of the list. <br>
<img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%203.2.PNG" width = "450" height = "325" >
...
<img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%203.3.PNG" width = "450" height = "325" >
5. Now all of the data that is highlighted purple is moved to the top of the list. <br>
<img src ="https://cshankle.github.io/AdvancedDataScience/hw1/Step%203.4.PNG" width = "450" height = "325" >
